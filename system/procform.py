...
class ProcWindow(UiProcForm):
    def __init__(self, Form, pid) -> None:
        super().__init__()
        self.setup_ui(Form)
    ...
    def fill_in(self):
        ...
        popka = psutil.Process(self.main_pid)
        processes = popka.children(recursive=True)
        names = []
        ids = []
        x = 0
        z = 0
